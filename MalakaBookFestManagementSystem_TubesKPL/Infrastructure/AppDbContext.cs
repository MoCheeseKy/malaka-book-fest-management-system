...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Enums removed to use HasConversion<string>
        ...
        modelBuilder.Entity<User>(e =>
        {
            ...
            e.Property(u => u.Role).HasColumnName("role").HasColumnType("user_role").HasConversion<string>();
        ...
        modelBuilder.Entity<Booth>(e =>
        {
            ...
            e.Property(b => b.Category).HasColumnName("category").HasColumnType("booth_category").HasConversion<string>();
        ...
        modelBuilder.Entity<Talkshow>(e =>
        {
            ...
            e.Property(t => t.Status).HasColumnName("status").HasColumnType("talkshow_status").HasConversion<string>();
        ...
        modelBuilder.Entity<Ticket>(e =>
        {
            ...
            e.Property(t => t.Type).HasColumnName("type").HasColumnType("ticket_type").HasConversion<string>();
            e.Property(t => t.Status).HasColumnName("status").HasColumnType("ticket_status").HasConversion<string>();
